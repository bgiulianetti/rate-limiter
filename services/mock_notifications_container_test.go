...
func (mock *NotificationsContainerMock) GetNotificationsByUser(params domain.GetNotificationParams) ([]*domain.Notification, error) {
	...
	return mock.GetNotificationsByUserFunc(params)
}
